...
| **Default Action Library** | ~50 pre-built actions for common apps (Chrome, Discord, Steam, Brave, etc.) |
...
> **Note**: Spanish, French, and German translations were generated with AI assistance. Community corrections are welcome via pull request.
...
│
├── Localization/
│   ├── en_US.xaml                 # English strings (~245 keys)
│   ├── it_IT.xaml                 # Italian strings
│   ├── es_ES.xaml                 # Spanish strings
│   ├── fr_FR.xaml                 # French strings
│   └── de_DE.xaml                 # German strings
│
├── Presets/
...
- [x] **Complete localization** — All hardcoded strings moved to XAML resource files (5 languages)
...
- [x] **Fix build scripts** — Localization files now included in `.pext` packaging
...
| Issue | Description |
|-------|-------------|
| ~~Hardcoded strings~~ | **Fixed in v0.5.0** — All UI strings now use the localization system. |
| ~~Build scripts incomplete~~ | **Fixed in v0.5.0** — `.pext` now includes all localization files. |
